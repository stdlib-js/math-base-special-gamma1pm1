...
```javascript
import gamma1pm1 from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-gamma1pm1@v0.3.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-gamma1pm1/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/math-base-special-gamma1pm1/actions/workflows/test.yml?query=branch:v0.3.0
