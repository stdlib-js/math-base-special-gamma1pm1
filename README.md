...
```javascript
gamma1pm1 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-gamma1pm1@v0.3.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-gamma1pm1@v0.3.0-umd/browser.js"></script>
```
